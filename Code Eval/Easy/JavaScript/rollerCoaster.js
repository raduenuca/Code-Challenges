(function() {
    ...
    var rollerCoaster = function(str) {
        var upperCase = true;
        ...
        var changeCase = function(letter) {
            ...
            letter = upperCase ? letter.toUpperCase() : letter;
            upperCase = !upperCase;
            
            return letter;
        };

        var rollerCoaserStr = curry(map_, changeCase);

        return compose(unletters, rollerCoaserStr, letters)(str.toLowerCase());
    };

    var rollerCoaster_ = curry(map_, rollerCoaster);

    var solution = compose(show, unlines, rollerCoaster_, nonEmpty, lines);
