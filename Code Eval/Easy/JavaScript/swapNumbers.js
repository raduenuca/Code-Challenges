(function() {
    ...
    var swapNumbers = function(str){
        var lenStr = str.length        
        var first = str[0];
        var last = str[lenStr - 1];
        
        if(first === last) {
            return str;
        }
        
        return last + str.substring(1, lenStr - 1) + first;
    };
    
    var swapNumbers_ = curry(map_, swapNumbers);
